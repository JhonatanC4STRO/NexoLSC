...
| R-02 | Avatar no permite configuraciones manuales claras | 4 | 5 | 20 | Prueba del esqueleto de animación con señas difíciles en Iteración 0 | Dedos o muñeca colapsan |
| R-03 | Sobrealcance para una sola persona | 5 | 4 | 20 | 20–30 intenciones y no-objetivos explícitos | Historia no cabe en una iteración |
...
| R-05 | transcripción automática falla por ruido o acento | 4 | 3 | 12 | Mostrar texto editable y mantener entrada manual | Aumentan correcciones |
| R-06 | Latencia degrada la interacción | 3 | 4 | 12 | Medir p95, limitar audio y precargar recursos | p95 supera 4 s |
| R-07 | GLB demasiado pesado | 3 | 3 | 9 | Presupuesto de peso y medición por iteración | Supera 15 MB |
| R-08 | Exposición de audio o clave | 2 | 5 | 10 | Servidor, eliminación temporal y revisión de secretos | Se detecta clave o archivo persistente |
...
- Revisar riesgos al planear y cerrar cada iteración.
- Cualquier exposición 15 o superior requiere una acción activa en el trabajo pendiente.
