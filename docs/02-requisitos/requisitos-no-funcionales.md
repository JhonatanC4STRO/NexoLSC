...
|---|---|---|---|
| RNF-001 | Rendimiento | La UI responderá a una interacción en menos de 200 ms, excluyendo servicios externos. | Equipo de referencia |
| RNF-002 | Latencia | La animación comenzará en menos de 4 s tras confirmar texto. | p95, red estable |
| RNF-003 | Animación | El reproductor mantendrá al menos 30 FPS. | Dispositivo de referencia |
| RNF-004 | Peso | El avatar inicial y sus recursos críticos no excederán 15 MB comprimidos. | **POR CONFIRMAR** |
| RNF-005 | Disponibilidad | Un fallo del STT permitirá continuar mediante texto. | Siempre |
| RNF-006 | Seguridad | Ninguna clave o secreto se incluirá en el bundle del navegador. | Inspección de build |
| RNF-007 | Privacidad | El audio se eliminará al terminar la transcripción, salvo consentimiento de prueba. | Backend y proveedor |
...
| RNF-013 | Observabilidad | Los errores tendrán código y contexto técnico sin guardar audio ni texto sensible completo. | Prueba de logs |
...
- Tamaño del audio y número de clips precargados.
